...
{
    switch ( line ) {
        case 0: THEPANEL->lcd->printf("Status"); break;
        ...
        case 2: THEPANEL->lcd->printf("Prepare Printer"); break;
        case 3: THEPANEL->lcd->printf("Move Print Head"); break;
        case 4: THEPANEL->lcd->printf("Probe"); break;
        case 5: THEPANEL->lcd->printf("About"); break;
...
void MainMenuScreen::clicked_menu_entry(uint16_t line)
{
    switch ( line ) {
        ...
        //case 4: setupConfigureScreen(); break;
        case 4: THEPANEL->enter_screen((new ProbeScreen())->set_parent(this)); break;
        case 5: THEPANEL->enter_screen(this->about_screen); break;
    }
}
